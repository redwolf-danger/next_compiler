        ...
        <div style={{border: "2px solid", height:"100vh"}}>
          {/* <PanelGroup direction="vertical"> */}
            ...
            {/* <PanelResizeHandle
              ...
              ref = {panel_div}
              id = "panel_div"
              style={{width:"11px",height:"100%",backgroundColor:"whitesmoke" ,display:"flex", flexDirection:"column", gap:"3px",justifyContent:"center",alignItems:"center",rotate:(screen_width<=300 ? 90: 0)}}>
                <Blank/>
